...
const QuestionContent: React.FC<{ readonly question: z.infer<typeof questionSchema> }> = ({ question }) => {
  switch (question.type) {
    ...
    case "quoteGuess":
      return <QuoteGuessQuestion quote={question.quote} character={question.character} />;
    case "factCheck":
      return <FactCheckQuestion facts={question.facts} />;
    case "villainGuess":
      return <VillainGuessQuestion villainImage={question.villainImage} blurAmount={question.blurAmount} />;
    case "firstFrame":
      return <FirstFrameQuestion frameImage={question.frameImage} />;
    case "subVsDub":
      return <SubVsDubQuestion subClip={question.subClip} dubClip={question.dubClip} />;
    default:
      return null;
  }
};
